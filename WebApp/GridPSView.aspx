<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="GridPSView.aspx.cs" Inherits="exam.GridPSView" %>
                          ...
                          <asp:Literal ID="Literal1" runat="server" Text="<%$appSettings:pcname%>" /></label>--%>
                            ...
                            <asp:Literal ID="Literal2" runat="server" Text="<%$appSettings:assemblyname%>" /></label>--%>
                                            <asp:DropDownList ID="ddlbooth" runat="server" CssClass="datalist border pr-md pl-xs py-xs"
                                                AutoPostBack="true" OnSelectedIndexChanged="ddlbooth_SelectedIndexChanged" Width="250px">
                                            </asp:DropDownList>
                                        </div>
                                    </td>
                                    <td class="pr-xs">
                                ...
                                <Triggers>
                                    ...
                                    <asp:PostBackTrigger ControlID="ddlbooth" />                                    
