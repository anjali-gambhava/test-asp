...
namespace exam
{
    public partial class CameraStatusIndoor : System.Web.UI.Page
    {
        ...
        private void LoadBooth(string usertype)
        {
            try
            {
                ...
                DataSet dspc = _dbadmin.allcountlivenewin(usertype, UserID);
                BoothList = dspc;
                ...
                DataSet dspc1 = _dbadmin.allcountlive_assemblyneworderbyin("", UserID, orderby);
                BoothList = dspc1;
                if (utypeall.StartsWith("eci"))
                {
