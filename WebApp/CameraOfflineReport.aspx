            ...
            <div class="card">
                 ...
                 <table  id="datatbl" class="table table-head-fixed">
                     ...
                     <tbody>
                         ...
                         TimeSpan datediff = TimeSpan.FromMinutes(Convert.ToInt32(dsReport.Tables[0].Rows[i]["DiffMin"]));%>
                                                    <tr >
                                                    ...
                                                    <%--<td class="p-thin text-left tshift"><%=dsReport.Tables[0].Rows[i]["ShiftName"].ToString() %></td>--%>
                                                  <%--  <td class="p-thin text-left toperinfo"><%=dsReport.Tables[0].Rows[i]["DriverName"].ToString() + " / " + dsReport.Tables[0].Rows[i]["DriverContactNo"].ToString() %></td>--%>
                                                    <td class="p-thin text-left tdid"><%=dsReport.Tables[0].Rows[i]["streamname"].ToString() %></td>
                                                    <%--<td class="p-thin text-left tdate"><%=Convert.ToDateTime(dsReport.Tables[0].Rows[i]["DayDate"]).ToString("dd/MM/yyyy") %></td>--%>
                                                    <td class="p-thin text-left tstarttime"><%=dsReport.Tables[0].Rows[i]["StartTime"].ToString() %></td>
                                                    <td class="p-thin text-left tendtime"><%=dsReport.Tables[0].Rows[i]["StopTime"].ToString() %></td>
