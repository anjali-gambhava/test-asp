...
namespace exam
{
    public partial class HrWizeReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Session["MenuName"] = "HrWizeReport";
                stateid = Convert.ToInt32(ConfigurationManager.AppSettings["stateid"]);
                if (!IsPostBack)
                {
                    FromDt.Text = DateTime.Now.Date.ToString("dd/MM/yyyy");
                    LoadDistrict();
                    GetCameraHourList();
                }
            }
        ...
        private void GetCameraHourList()
        {
            var ds = _data.GetCameraHourList(ddlDistrict.SelectedValue, ddlAssembly.SelectedValue, FromDt.Text);
            dsReport = ds;
        }
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Second Trial Run " + DateTime.Now.ToString() + ".xlsx");
        ...
        protected void btnExportPDF_Click(object sender, EventArgs e)
        {
            ...
            GeneratePDF(dtPdf, "Second Trial Run ");
        }
