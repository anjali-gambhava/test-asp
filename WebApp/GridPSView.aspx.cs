...
namespace exam
{
    public partial class GridPSView : System.Web.UI.Page
    {
        ...
        private void LoadBooth(string usertype)
        {
            try
            {
                ...
                var dsNew = _boothgrid.GetBoothListNewPSView(ddlDistrict.SelectedValue, ddlAssembly.SelectedValue, ddlbooth.SelectedValue);
        ...
        private void LoadDistrict(string usertype)
        {
            try
            {
                ...
                ddlbooth.Items.Insert(0, new ListItem("ALL School", ""));
            }
            catch (Exception ex)
            {
        ...
        protected void ddlDistrict_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                LoadAssembly();
                LoadSchool(ddlAssembly.SelectedValue);
                LoadBooth(usertype);
            }
            catch (Exception ex)
            {
        ...
        private void LoadSchool(string acname)
        {
            try
            {
                ...
                //else
                //{
                //    ds_booth = _boothgrid.GetBoothFromDistrictPC(District, acname);
                //}
                ddlbooth.Items.Clear();
                ds_booth = _boothgrid.GetAllSchoolByAssembly(acname);
                ddlbooth.DataSource = ds_booth;
                ddlbooth.DataTextField = "location";
                ddlbooth.DataValueField = "location";
                ddlbooth.DataBind();
                ddlbooth.Items.Insert(0, new ListItem("ALL School", ""));
            ...
            {
                Common.Log("LoadSchool() -- >  " + ex.Message);
            }
        }
        //protected void ddlDistrict_SelectedIndexChanged(object sender, EventArgs e)
        //{
