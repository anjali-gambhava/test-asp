<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="VideoBitrate.aspx.cs" Inherits="exam.VideoBitrate" %>
                 ...
                 <table  id="datatbl" class="table table-head-fixed">
                       <thead>
                                                <tr>
                                                    ...
                                                    <th class="p-thin text-left">Time</th>
                                                    <th class="p-thin text-left">Bitrate</th> 
                                                </tr>
                                                    </thead>
                     <tbody>
                                              <% if (dsReport.Tables[0].Rows.Count > 0)%>
                                                ...
                                                <td class="p-thin text-left"><%=dsReport.Tables[0].Rows[i]["location"].ToString() %></td>
                                                    <td class="p-thin text-left"><%=dsReport.Tables[0].Rows[i]["CameraID"].ToString() %></td>
                                                     <td class="p-thin text-left"><%=dsReport.Tables[0].Rows[i]["VideoTime"].ToString() %></td>
                                                     <td class="p-thin text-left"><%=dsReport.Tables[0].Rows[i]["Bitrate"].ToString() %></td>
                                                </tr>
                                                <%} %>
                          <%} %>
                                                    </tbody>
            ...
            $j('#datatbl').DataTable({
                ...
                buttons: [
                    //'copy', 'csv', 'excel', 'pdf', 'print'
                    {
                        ...
                        pageSize: 'LEGAL',
                        title: '<%=ConfigurationManager.AppSettings["CameraStatusReport_2_excel_title"].ToString()%> - Video Bitrate Report ' + newdate,
                    ...
                    },
                    {
                        ...
                        orientation: 'landscape',
                        pageSize: 'LEGAL',
                        title: '<%=ConfigurationManager.AppSettings["CameraStatusReport_2_pdf_title"].ToString()%> -  Video Bitrate REPORT ' + newdate,
