...
namespace exam
{
    public partial class GridPinkView : System.Web.UI.Page
    {
        ...
        private void LoadBooth(string usertype)
        {
            try
            {
                ...
                var dsNew = _boothgrid.GetBoothListNewPinkView(ddlDistrict.SelectedValue, ddlAssembly.SelectedValue);
