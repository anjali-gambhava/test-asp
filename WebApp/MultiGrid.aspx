<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="MultiGrid.aspx.cs" Inherits="exam.MultiGrid" %>
    ...
    <div class="row">
        <div id="fldiv" class="bg-white"><%-- class="embed-responsive embed-responsive-16by9"--%>
            ...
            <div>
                ...
                <asp:Timer ID="Timer1" runat="server" Interval="90000" OnTick="Timer1_Tick" Enabled="true">
    </asp:Timer>
                                        ...
                                        <ItemTemplate>
                                            <div class="col-12 md:col-<%=12/gridcolumns %> col4 pb-xs" align="center">
                                                ...
                                                <div class="card">
                                                  ...
                                                  <div class="px-thin d-hidden">
                                                      <p class="heading word-break-all" title="<%#Eval("district")%>"><%#(Eval("district").ToString()) %> / <%#(Eval("acname").ToString()) %> / <%#(Eval("PSNum").ToString()) %></p>
                                                      <div class="flex-row flex-wrap">
                                                          ...
                                                          <div class="col-12 md:col-4 col4">
                                                              ...
                                                              <div class="data word-break-all"> <%#Eval("streamname").ToString()%> </div>
                                                          </div>
                                                       <div class="col-12 md:col-8 col8">
                                                              <p class="sub-heading word-break-all"><b>Average kbps/seconds:-</b>
                                                                    <div class="data word-break-all"><%#Eval("kbpsp")%></div></p>
                                                          </div>
                                                      </div>
                                                  </div>
                                                </div>
