...
namespace exam
{
    public partial class MultiGridView : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Common.Log("Page_Load_grid() -- >  " + ex.Message);
            }
        }
        ...
        private void LoadBooth(string usertype)
        {
            try
            {
                ...
                alldata = alldata.OrderBy(x => x.status).ThenBy(x => x.district);
                ...
                listview1.DataSource = alldata.Skip(startRow).Take(pageitemcount).ToList();
                listview1.DataBind();
