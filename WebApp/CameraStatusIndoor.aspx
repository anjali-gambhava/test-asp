<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="CameraStatusIndoor.aspx.cs" Inherits="exam.CameraStatusIndoor" %>
...
<%--<asp:RadioButton runat="server" Text="TOTAL PS" GroupName="headerRadioButton" CssClass="unselectedRadioButton" ID="test" OnCheckedChanged="RadioButton_CheckedChanged" />--%>
    ...
    <script type="text/javascript">
        function loadac(pcname, i) {
            if ($("#trac_" + i).is(':visible')) {
                ...
                $.get('assemblyin.aspx?pcname=' + pcname, function (data) {
                    //hide all open trac_
                    $('[id^=trac_]').hide();
    ...
    <script>
     ...
     <script type="text/javascript"> 
         $('#camerastatusinmenu').addClass('active');
     </script>
</asp:Content>
