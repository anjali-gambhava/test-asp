...
namespace exam
{
    public partial class GridAutoView : System.Web.UI.Page
    {
        ...
        private void LoadBooth(string usertype)
        {
            try
            {
                ...
                var dsNew = _boothgrid.GetBoothListNewAutoView(ddlDistrict.SelectedValue, ddlAssembly.SelectedValue);
